 ...
 * 
 * Manages CRUD operations for user's saved AI prompts.
 */
...
/**
 * Server-side: Get prompts (for API routes)
 */
export async function getPromptsServer(userId: string): Promise<AIPrompt[]> {
